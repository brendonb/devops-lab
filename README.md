...
webserver that copies the html and css files into the container when the docker build command has been issued.The image is then copied to the staging server using secret text authentication
